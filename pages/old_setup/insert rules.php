...
$sql="INSERT INTO WPPC_Rules(RULE_ID, TEXT_CONTENT_DOCUMENT, SEARCH_SIMILAR_1, SEARCH_SIMILAR_2, SEARCH_SIMILAR_3, SEARCH_SIMILAR_4, SEARCH_SIMILAR_5, reg_date) VALUES ('$ruleid', '$text_content', '$SEARCH_SIMILAR_1', '$SEARCH_SIMILAR_2', '$SEARCH_SIMILAR_3', '$SEARCH_SIMILAR_4', '$SEARCH_SIMILAR_5', '$reg_date')";

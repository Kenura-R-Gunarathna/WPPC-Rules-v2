...
$("#inbox_massages_table_content_error").height($(window).height() - $("#row_1").height() -50-0.1-20.909-40);
$("#outbox_massages_table_content_error").height($(window).height() - $("#row_1").height() -50-0.1-20.909-40);
$("#trash_massages_table_content_error").height($(window).height() - $("#row_1").height() -50-0.1-20.909-40);
$('.click_get_id_for_delete_img_1').bind('click', function(){
var table_of_search_results_id_for_delete = $(this).attr('id'); // gets the id of a clicked link that has a class of menu
var from_what="INBOX";
              $.post( 
                  "../data/php/delete_massage_completely_1.php",
                  { acc_email: acc_email,
                    acc_passw: acc_passw, 
					from_what: from_what,
					table_of_search_results_id_for_delete: table_of_search_results_id_for_delete },
                  function(data) {
                     $("#massage_control_proltocaol_2").html(data);
                  }
               );
});
$('.click_get_id_for_delete_img_2').bind('click', function(){
var table_of_search_results_id_for_delete = $(this).attr('id'); // gets the id of a clicked link that has a class of menu
var from_what="OUTBOX";
              $.post( 
                  "../data/php/delete_massage_completely_2.php",
                  { acc_email: acc_email,
                    acc_passw: acc_passw, 
					from_what: from_what,
					table_of_search_results_id_for_delete: table_of_search_results_id_for_delete },
...
$('.click_get_id_for_open_img_3').bind('click', function(){
var table_of_search_results_id_for_open_3 = $(this).attr('id'); // gets the id of a clicked link that has a class of menu
var from_what="INBOX";
              $.post( 
                  "../data/php/open_massage_3.php",
                  { acc_email: acc_email,
                    acc_passw: acc_passw, 
					from_what: from_what,
					table_of_search_results_id_for_open_3: table_of_search_results_id_for_open_3 },
                  function(data) {
					 $("#alert_01").show(0);
...
$('.click_get_id_for_open_img_4').bind('click', function(){
var table_of_search_results_id_for_open_4 = $(this).attr('id'); // gets the id of a clicked link that has a class of menu
var from_what="INBOX";
              $.post( 
                  "../data/php/open_massage_4.php",
                  { acc_email: acc_email,
                    acc_passw: acc_passw, 
					from_what: from_what,
					table_of_search_results_id_for_open_4: table_of_search_results_id_for_open_4 },
                  function(data) {
					 $("#alert_01").show(0);
		             $("#container_01").slideDown(500);
					 $("#span_01").html(data); 
...
$sql = "SELECT * FROM INBOX WHERE `email`='$acc_email' AND `delete`='deleted' ORDER BY `reg_date` DESC";
...
echo'
<div width="100%" class="trash_email_title"style="">
<span class="fontsforweb_fontid_423"style="color:white;padding-right:20px;"><img src="../data/png/trash.png" style=""  width="10px"title="Trash"></span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">Trash > Inbox</span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">'.$acc_email.'</span>
</div>
<style>
.trash_email_title{padding:15px;background-color:#0099e6;color:white;opacity:0.9;}
.trash_email_title:hover{padding:15px;background-color:#0099e6;color:white;opacity:0.95;cursor:pointer;}
</style>

<table align="center"cellspacing="0px"width="100%" border="1px"style="border-width:0px 0px 0px 0px;border-style:solid;">
<tr>
<th class="fontsforweb_fontid_423" align="left"height="50px" style="color:white;padding:3px;background-color:black;opacity:0.6;border-width:0px 0px 0px 0px;">From/To</th>
...
<td class=" fontsforweb_fontid_423"align="left"style="color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;width:25%;overflow:hidden;">'.$row["email"].'</td>
...
<img class="click_get_id_for_open_img_3"src="../data/png/open.png" id="'.$row["id"].'" width="20px"title="Open">&nbsp&nbsp
<img class="click_get_id_for_delete_img_1"src="../data/png/delete.png" id="'.$row["id"].'" width="20px"title="Delete"></td>
...
';
	...
	echo'
<div width="100%" class="trash_email_title"id="trash_massages_table_title_error">
<span class="fontsforweb_fontid_423"style="color:white;padding-right:20px;"><img src="../data/png/trash.png" style=""  width="10px"title="Trash"></span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">Trash</span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">'.$acc_email.'</span>
</div>
<style>
.trash_email_title{padding:15px;background-color:#0099e6;color:white;opacity:0.9;}
.trash_email_title:hover{padding:15px;background-color:#0099e6;color:white;opacity:0.85;cursor:pointer;}
</style>
<table id="trash_massages_table_content_error"width="100%"height="100%"border="0px"align="center"style="">
<tr>
<td align="center">
<font class="fontsforweb_fontid_423" color="gray"style="font-size:42px;">';
echo "0 Massages in trash! ";
echo'</font><br><br>
<font class="fontsforweb_fontid_423" color="gray"style="font-size:14px;">';
echo "You has permenently deletd all the emails.<br><br>";
echo"<style>
...
$sql = "SELECT * FROM OUTBOX WHERE `email`='$acc_email' AND `delete`='deleted' ORDER BY `reg_date` DESC";
$result = mysqli_query($conn, $sql);
...
<div width="100%" class="trash_email_title"style="">
<span class="fontsforweb_fontid_423"style="color:white;padding-right:20px;"><img src="../data/png/trash.png" style=""  width="10px"title="Trash"></span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">Trash > Outbox</span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">'.$acc_email.'</span>
</div>
<style>
.trash_email_title{padding:15px;background-color:#0099e6;color:white;opacity:0.9;}
...
<td class=" fontsforweb_fontid_423"align="left"style="color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;width:30%;overflow:hidden;">'.$row["title"].'</td>
<td class=" fontsforweb_fontid_423"align="left"style="color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;width:20%;overflow:hidden;">
<img class="click_get_id_for_open_img_4"src="../data/png/open.png" id="'.$row["id"].'" width="20px"title="Open">&nbsp&nbsp
<img class="click_get_id_for_delete_img_2"src="../data/png/delete.png" id="'.$row["id"].'" width="20px"title="Delete"></td>
<td class=" fontsforweb_fontid_423"align="left"style="color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;width:25%;overflow:hidden;">'.$row["reg_date"].'</td>
</tr>

...
<?php
$acc_email_5678_45_600 = htmlspecialchars($_POST['acc_email']);
$acc_passw_5678_45_600 = htmlspecialchars($_POST['acc_passw']);
$table_of_search_results_id_for_open_2 = htmlspecialchars($_POST['table_of_search_results_id_for_open_2']);
...
$sql = "SELECT * FROM `OUTBOX` WHERE `email`='$acc_email_5678_45_600' And `id`='$table_of_search_results_id_for_open_2' ";
...
echo'
		    <div class="header_01">
            <p class="fontsforweb_fontid_423">Massage to '.$row["email_to"].'</p>
			</div>
			
			<div class="body_01">
            <p class="fontsforweb_fontid_423" align="left"style="padding:0px 0px 0px 10px;">To : '.$row["email_to"].'</p>
			...
			<p class="fontsforweb_fontid_423"align="left"style="padding:0px 0px 0px 10px;">Send date :'.$row["reg_date"].'</p>
			</div>

...
$table_of_search_results_id_for_open = htmlspecialchars($_POST['table_of_search_results_id_for_open']);
...
$sql = "SELECT * FROM `INBOX` WHERE `email`='$acc_email_5678_45_60' And `id`='$table_of_search_results_id_for_open' ";

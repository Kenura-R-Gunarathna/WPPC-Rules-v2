...
$table_of_search_results_id_for_open_4 = htmlspecialchars($_POST['table_of_search_results_id_for_open_4']);
...
$sql = "SELECT * FROM `OUTBOX` WHERE `email`='$acc_email_5678_45_60' And `id`='$table_of_search_results_id_for_open_4' AND `delete`='deleted' ";

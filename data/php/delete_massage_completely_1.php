...
$table_of_search_results_id_for_delete_5678_6 = htmlspecialchars($_POST['table_of_search_results_id_for_delete']);
...
$sql = "DELETE FROM INBOX WHERE `id`='$table_of_search_results_id_for_delete_5678_6' AND `delete`='deleted'";

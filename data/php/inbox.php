...
$('.click_get_id_for_open_img').bind('click', function(){
var table_of_search_results_id_for_open = $(this).attr('id'); // gets the id of a clicked link that has a class of menu
var from_what="INBOX";
              $.post( 
                  "../data/php/open_massage.php",
                  { acc_email: acc_email,
                    acc_passw: acc_passw, 
					from_what: from_what,
					table_of_search_results_id_for_open: table_of_search_results_id_for_open },
                  function(data) {
					 $("#alert_01").show(0);
...
$sql = "SELECT * FROM INBOX WHERE email='$acc_email' AND `delete`='' ORDER BY `reg_date` DESC";
...
echo'
<div width="100%" class="inbox_email_title"style="">
<span class="fontsforweb_fontid_423"style="color:white;padding-right:20px;"><img src="../data/png/inbox.png" style=""  width="10px"title="Inbox"></span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">Inbox</span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">'.$acc_email.'</span>
</div>
<style>
.inbox_email_title{padding:15px;background-color:#0099e6;color:white;opacity:0.9;}
.inbox_email_title:hover{padding:15px;background-color:#0099e6;color:white;opacity:0.95;cursor:pointer;}
</style>
...
<tr id="'.$row["id"].'" class="hover_td_color_bg_color_cursor click_get_id_for_delete">
<td id="'.$row["id"].'"class=" fontsforweb_fontid_423 click_get_id_for_delete"align="left"style="width:25%;overflow:hidden;color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;">'.$row["email_from"].'</td>
<td  id="'.$row["id"].'"class=" fontsforweb_fontid_423 click_get_id_for_delete"align="left"style="width:30%;overflow:hidden;color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;">'.$row["title"].'</td>
<td  id="'.$row["id"].'"class=" fontsforweb_fontid_423 click_get_id_for_delete"align="left"style="width:20%;overflow:hidden;color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;">
<img class="click_get_id_for_open_img"src="../data/png/open.png" id="'.$row["id"].'" width="20px"title="Open">&nbsp&nbsp
<img class="click_get_id_for_delete_img"src="../data/png/delete.png" id="'.$row["id"].'" width="20px"title="Delete"></td>
<td  id="'.$row["id"].'"class=" fontsforweb_fontid_423 click_get_id_for_delete"align="left"style="width:25%;overflow:hidden;color:gray;border-style:solid;border-width:0px 0px 1px 0px;border-color:#cccccc;padding:10px 3px 10px 3px;">'.$row["reg_date"].'</td>
</tr>
...
echo'
<div width="100%" class="inbox_email_title"id="inbox_massages_table_title_error">
<span class="fontsforweb_fontid_423"style="color:white;padding-right:20px;"><img src="../data/png/inbox.png" style=""  width="10px"title="Inbox"></span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">Inbox</span>
<span class="fontsforweb_fontid_423"style="padding-right:20px;color:white;">'.$acc_email.'</span>
</div>
<style>
.inbox_email_title{padding:15px;background-color:#0099e6;color:white;opacity:0.9;}
.inbox_email_title:hover{padding:15px;background-color:#0099e6;color:white;opacity:0.85;cursor:pointer;}
</style>
<table id="inbox_massages_table_content_error"width="100%"height="100%"border="0px"align="center"style="">
<tr>
<td align="center">
<font class="fontsforweb_fontid_423" color="gray"style="font-size:42px;">';
echo "0 Massages in inbox! ";
echo'</font><br><br>
